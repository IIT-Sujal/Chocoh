...
create table orders(order_id int primary key not null auto_increment,total_amount int,delivery_address char(100));
create table chocolate(chocolate_id int primary key not null auto_increment,price int,name char(50) not null,quantities_available int,quantities_sold int,ratings int);
...
create table payment(payment_id int primary key not null auto_increment,payment_type char(10),status char(10));
...
create table purchased_product(order_id int, foreign key(order_id) references orders(order_id), chocolate_id int, foreign key(chocolate_id) references chocolate(chocolate_id));
create table user_cart(user_id int, foreign key(user_id) references user(user_id),chocolate_id int, foreign key(chocolate_id) references chocolate(chocolate_id),quantity int);
...
create table bank_used(card_no char (16), foreign key(card_no) references bank_details(card_no),payment_id int, foreign key(payment_id) references payment(payment_id));
...
insert into chocolate(name,price,quantities_available,quantities_sold,ratings) values("fruit and nut",300,10,10,5);
insert into chocolate(name,price,quantities_available,quantities_sold,ratings) values("fruit and nut",301,10,10,5);
insert into chocolate(name,price,quantities_available,quantities_sold,ratings) values("fruit and nut",302,10,10,5);
insert into chocolate(name,price,quantities_available,quantities_sold,ratings) values("fruit and nut",303,10,10,5);
insert into chocolate(name,price,quantities_available,quantities_sold,ratings) values("fruit and nut",304,10,10,5);
insert into chocolate(name,price,quantities_available,quantities_sold,ratings) values("fruit and nut",305,10,10,5);
