...
create table orders(order_id int primary key not null auto_increment,total_amount int,delivery_address char(100),mobile_no char(10),delivery_date date,order_date date,delivery_status char(20) default 'not started',return_status char(10) default 'false');
...
create table transaction(order_id int, foreign key(order_id) references orders(order_id),payment_id char(20), foreign key(payment_id) references payment(payment_id),time_stamp time);
create table pays(user_id int ,foreign key(user_id) references user(user_id),payment_id char(20), foreign key(payment_id) references payment(payment_id));
